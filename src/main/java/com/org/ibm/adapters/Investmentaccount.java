...
@Component
public class Investmentaccount implements JavaDelegate{

    @Autowired
    private Utility utility;

    @Autowired
    private InvestmentAccountRestProcessor restProcessor;

    private final static Logger LOGGER = Logger.getLogger(Investmentaccount.class.getName());
    ...
    public void execute(DelegateExecution execution) throws Exception {
         ...
         if(response instanceof ApiError ||  response instanceof GenericError){
            //Failure Path
            throw new RuntimeException("Error occurred in the adapter:"+Investmentaccount.class.getName());
         }else{
